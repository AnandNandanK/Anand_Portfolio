...
const appRouter = createBrowserRouter([
  ...
  },
  {
    ...
    element: <ProtectedRoute> <UpdateProject/> </ProtectedRoute> 
  },
  {
    path: '/dashboard/editprojects',
    element: <ProtectedRoute> <EditProjects/> </ProtectedRoute> 
  },
  {
...
function App() {
  ...
  console.log("Printng Theam....",theam)
  

  return (
    <div className={`${theam?"transition-all duration-300 bg-[url('./src/assets/hd.jpg')]":" transition-all duration-300 bg-[url('./w3.jpg')]"} bg-cover bg-center h-screen bg-fixed overflow-x-hidden `}>
